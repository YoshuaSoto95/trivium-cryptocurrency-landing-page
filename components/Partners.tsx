...
const exchangeLogos = [
    ...
    { name: 'KuCoin', src: 'https://cdn.worldvectorlogo.com/logos/kucoin-token-kcs.svg' },
    { name: 'Bybit', src: 'https://cdn.worldvectorlogo.com/logos/bybit.svg' },
    { name: 'Crypto.com', src: 'https://cdn.worldvectorlogo.com/logos/crypto-com-1.svg' },
    { name: 'OKX', src: 'https://cdn.worldvectorlogo.com/logos/okx.svg' },
    { name: 'Gate.io', src: 'https://cdn.worldvectorlogo.com/logos/gate-io.svg' },
    { name: 'Kraken', src: 'https://cdn.worldvectorlogo.com/logos/kraken.svg' },
    { name: 'Bitfinex', src: 'https://cdn.worldvectorlogo.com/logos/bitfinex.svg' },
    { name: 'HTX', src: 'https://cdn.worldvectorlogo.com/logos/htx-1.svg' },
];
  ...
  return (
    <section id="partners" className="relative min-h-screen flex flex-col items-center justify-center py-24 px-4 sm:px-6 lg:px-8 snap-start overflow-hidden">
        ...
        <div className="w-full mt-auto py-12">
            <h3 className="text-center text-white/60 text-lg mb-8">Actively Traded On</h3>
            <div 
